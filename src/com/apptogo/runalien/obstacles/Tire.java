...
public class Tire extends Obstacle{
	...
	public Tire(PhysicsWorld physicsWorld, Entity foregroundLayer){
		sprite = new Sprite(-1000, 200, ResourcesManager.getInstance().tire_region, ResourcesManager.getInstance().vbom);
		//narazie pozycja x jest zero ale ostateznie musi byc minus wpizdu zeby na poczatku ich nie bylo widac
		sprite.setUserData("upper_tire");
