...
public class Upper_thunder extends Obstacle{
	private Sprite sprite;
	private Body body;
	
	public Upper_thunder(PhysicsWorld physicsWorld, Entity foregroundLayer){
		sprite = new Sprite(-1000, 110, ResourcesManager.getInstance().thunder_region, ResourcesManager.getInstance().vbom);
		//narazie pozycja x jest zero ale ostateznie musi byc minus wpizdu zeby na poczatku ich nie bylo widac
		sprite.setUserData("upper_thunder");
