...
public class Bottom_weasel extends Obstacle{
	private Sprite sprite;
	private Body body;
	
	public Bottom_weasel(PhysicsWorld physicsWorld, Entity foregroundLayer){
		sprite = new Sprite(-1000, 110, ResourcesManager.getInstance().weasel_region, ResourcesManager.getInstance().vbom);
		//narazie pozycja x jest zero ale ostateznie musi byc minus wpizdu zeby na poczatku ich nie bylo widac
		sprite.setUserData("bottom_weasel");
