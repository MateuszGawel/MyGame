...
public class Upper_3 extends Obstacle{
	
	private Sprite sprite;
	private Body body;
	
	public Upper_3(PhysicsWorld physicsWorld, Entity foregroundLayer){
		sprite = new Sprite(-1000, 100, ResourcesManager.getInstance().upper_3_region, ResourcesManager.getInstance().vbom);
