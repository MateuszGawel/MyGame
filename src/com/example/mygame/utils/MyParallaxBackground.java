 ...
 */
public class MyParallaxBackground extends Background {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public MyParallaxBackground(final float pRed, final float pGreen, final float pBlue) {
	...
	public static class ParallaxEntity {
		...
		public void setParallaxFactor(float mParallaxFactor){
		...
		public float getmParallaxFactor() {
